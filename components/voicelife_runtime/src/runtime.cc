   ...
   public:
    ...
    Status Start(PlatformAssembly& assembly) {
        ...
        if (!schedule_mcp_registered_) {
            ...
            ESP_LOGI(
                kTag,
                "MCP_TOOLS_READY count=13 names=schedule.create,schedule.create_rule,schedule.query,schedule.update,schedule.update_occurrence,schedule.update_rule,schedule.delete,schedule.delete_rule,schedule.skip_occurrence,"
